<section class="dblock flexbox light" style="background-image:url('/wp-content/themes/yes.my/images/yes2018/Group 2511.jpg');">
    <div class="fullscreen centerize center-text">
        <div>
            <p class="shoutout lg"><b>Little gifts</b> that<br /> brighten your day.</p>
        </div>
    </div>
...
<section class="dblock flexbox alt">
    <div class="centerize center-text" style="height:600px;">
        <div style="max-width:1084px;">
            <p class="shoutout brand lg" style="margin-bottom:0.25em;"><b>Own a brand</b> you’d love to bring to more Malaysians?</p>

            <p class="shoutout-note grey" style="margin-bottom:1.67em;">Say Yes, to more customers. Become a Yes partner!</p>
            <a class="accent" href="/rewards/partnership"><b><u>Be a partner</u></b></a>
        </div>
    </div>
</section>

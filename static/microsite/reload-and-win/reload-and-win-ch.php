    ...
    <section class="d-block" id="sec-01"> 
        <div class="layer-content banner">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <img class="d-block d-lg-none img-mobile" src="/wp-content/themes/yes.my/images/reload-and-win/img-header-ch.png" alt="Reload & Win" title="Reload & Win" />
                        <img class="d-none d-lg-block img-fluid" src="/wp-content/themes/yes.my/images/reload-and-win/img-header-ch.png" alt="Reload & Win" title="Reload & Win" />
                    </div>
                </div>
                <div class="row layer-pullUp pb-4">
                    <div class="col-lg-10 offset-lg-1 text-center">
                        <div class="text-01 text-center mb-4">立即参加并开始赢奖！</div>
                        <div class="layer-btn">
                            <div class="row">
                                <div class="col-12 text-center">
                                    <a href="#more" class="btn-01 btn-scroll-down">查询详情</a>
                                </div>
            ...
            <div class="layer-pullUp pullUp-monthly">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-10 offset-lg-1">
                                <img class="d-block d-lg-none img-fluid" src="/wp-content/themes/yes.my/images/reload-and-win/table-monthly-prizes-ch-mobile.png" alt="Monthly Grand Prizes" title="Monthly Grand Prizes" />
                                <img class="d-none d-lg-block img-fluid" src="/wp-content/themes/yes.my/images/reload-and-win/table-monthly-prizes-ch.png" alt="Monthly Grand Prizes" title="Monthly Grand Prizes" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3 col-sm-6 offset-sm-3">
                            <div class="text-center">
                                <img class="img-fluid" src="/wp-content/themes/yes.my/images/reload-and-win/table-weekly-prizes-ch.png" alt="Weekly Prizes" title="Weekly Prizes" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="layer-bgDots dots-reload layer-pullUp text-center">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <div class="text-01 mb-4">充值或获取附加上网数据！</div>
                            </div>
                            <div class="col-12">
                                <a href="#how-to" class="btn-01 btn-scroll-down">立即充值</a>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 offset-lg-0 col-sm-8 offset-sm-2 pb-5 pb-lg-0 text-center">
                        <img class="img-fluid mb-5" src="/wp-content/themes/yes.my/images/reload-and-win/how-to-reload-ch.png" alt="How to Reload" title="How to Reload" />
                        <a href="https://selfcare.yes.my/myselfcare/doExpressPay.do" class="btn-01 text-white">立即充值</a>
                    </div>
                    <div class="col-lg-6 offset-lg-0 col-sm-8 offset-sm-2 pb-5 pb-lg-0 text-center">
                        <img class="img-fluid mb-5" src="/wp-content/themes/yes.my/images/reload-and-win/how-to-buy-add-ons-ch.png" alt="How to Buy Add-Ons" title="How to Buy Add-Ons" />
                        <a href="https://selfcare.yes.my/myselfcare/doExpressPay.do" class="btn-01 text-white">立即选购</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="layer-content">
            <div class="layer-bgHighlight">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 offset-lg-1">
                            <div class="text-01 text-center mb-5">每次购买，您都将获得票券以增加您的赢奖机会甚至让您赢取大奖！</div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2 col-sm-8 offset-sm-2">
                            <img class="img-fluid" src="/wp-content/themes/yes.my/images/reload-and-win/table-tickets-ch.png" alt="Tickets" title="Tickets" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="layer-bgDots">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="text-02">
                                <span class="mt-0">通过</span>
                                <img src="/wp-content/themes/yes.my/images/reload-and-win/yes-app.png" alt="YES" title="YES" width="100" /> <br />
                                <span>充值</span>
                            </div>
                            <a href="https://play.google.com/store/apps/details?id=my.yes.yes4g"><img src="/wp-content/themes/yes.my/images/reload-and-win/btn-download-ch.png" alt="Download Now" title="Download Now" width="320" /></a>
                        </div>
                    </div>
                </div>
            </div>

    ...
    <section class="d-block" id="sec-01"> 
        <div class="layer-content banner">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <img class="d-block d-lg-none img-mobile" src="/wp-content/themes/yes.my/images/reload-and-win/img-header.png" alt="Reload & Win" title="Reload & Win" />
                        <img class="d-none d-lg-block img-fluid" src="/wp-content/themes/yes.my/images/reload-and-win/img-header.png" alt="Reload & Win" title="Reload & Win" />
                    </div>
                </div>
                <div class="row layer-pullUp pb-4">
                    <div class="col-lg-10 offset-lg-1 text-center">
                        <div class="text-01 text-center mb-4">Join in to start winning now!</div>
                        <div class="layer-btn">
                            <div class="row">
                                <div class="col-12 text-center">
                                    <a href="#more" class="btn-01 btn-scroll-down">FIND OUT MORE</a>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <div class="text-01 text-center">
                                Join our Reload & Win! <br />
                                The more you reload or buy data add-ons,
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-10 offset-lg-1">
                                <img class="d-block d-lg-none img-fluid" src="/wp-content/themes/yes.my/images/reload-and-win/table-monthly-prizes-mobile.png" alt="Monthly Grand Prizes" title="Monthly Grand Prizes" />
                                <img class="d-none d-lg-block img-fluid" src="/wp-content/themes/yes.my/images/reload-and-win/table-monthly-prizes.png" alt="Monthly Grand Prizes" title="Monthly Grand Prizes" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3 col-sm-6 offset-sm-3">
                            <div class="text-center">
                                <img class="img-fluid" src="/wp-content/themes/yes.my/images/reload-and-win/table-weekly-prizes.png" alt="Weekly Prizes" title="Weekly Prizes" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 offset-lg-3">
                                <div class="text-01 mb-4">Reload or get data add-ons to start winning!</div>
                            </div>
                            <div class="col-12">
                                <a href="#how-to" class="btn-01 btn-scroll-down">RELOAD NOW</a>
                            </div>
        ...
        <div class="layer-content">
            <div class="layer-bgHighlight">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 offset-lg-1">
                            <div class="text-01 text-center mb-5">With every purchase, you'll get tickets to increase your chances for the winning draw - you could even be in the running for the Grand Prize!</div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2 col-sm-8 offset-sm-2">
                            <img class="img-fluid" src="/wp-content/themes/yes.my/images/reload-and-win/table-tickets.png" alt="Tickets" title="Tickets" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="layer-bgDots">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="text-02">
                                <span class="mt-0">Reload via</span>
                                <img src="/wp-content/themes/yes.my/images/reload-and-win/yes-app.png" alt="YES" title="YES" width="100" /> <br />
                                <span>app</span>
                            </div>
                            <a href="https://play.google.com/store/apps/details?id=my.yes.yes4g"><img src="/wp-content/themes/yes.my/images/reload-and-win/btn-download.png" alt="Download Now" title="Download Now" width="320" /></a>
                        </div>
                    </div>
                </div>
            </div>

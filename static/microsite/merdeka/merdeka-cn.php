...
<div class="layer-bgContent">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-7 col-lg-8 text-center">
                        <img class="d-block d-lg-none" src="/wp-content/themes/yes.my/images/merdeka-63/microsite/headline-cn-mobile.png" width="100%" />
                        <img class="d-none d-lg-block" src="/wp-content/themes/yes.my/images/merdeka-63/microsite/headline-cn.png" width="100%" />
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-5 text-center">
                        <div class="cp-02 d-lg-none mb-5">获享 <b>SAMSUNG GALAXY A02</b> 只需 <span class="tag-bgWhite">RM1</span></div>
                        <img class="img-phone2" src="/wp-content/themes/yes.my/images/merdeka-63/microsite/handphone.png" width="100%" />
                    </div>
                    <div class="col-lg-7">
                        <div class="cp-02 d-none d-lg-block">获享 <b>SAMSUNG GALAXY A02</b> <br />只需 <span class="tag-bgWhite">RM1</span></div>
                        <div class="row">
                            <div class="col-lg-7">
                                <div class="ico-ar mb-4">
                                    <div class="row justify-content-center">
                                        <div class="col-lg col-4 mt-3">
                                            ...
                                            <div class="tag xs mt-2 pl-0 pr-0">Samsung Galaxy <br />A02 只需 RM1</div>
                                        </div>
                                        <div class="col-lg col-4 mt-3">
                                            <img alt="" src="/wp-content/themes/yes.my/images/prihatin/phase-2/icon-free-data-100gb.png" width="100%">
                                            <div class="tag xs mt-2">100GB 数据 + <br />无限数据</div>
                                        </div>
                                        <div class="col-lg col-4 mt-3">
                        ...
                        <div class="cp-03 mb-4 pt-3"><span class="yes-font">YES</span>后付配套国庆RM 1 套组（<span class="yes-font">YES</span> POSTPAID MERDEKA BUNDLE RM1）让您只需 RM1 即可获享全新的智能手机设备，而且免费直送到您家，附加每月可享有高达 100GB 数据长达12个月。</div>
                        <div class="text-center-mobile">
                            <a class="btn-01 tuntut" href="https://appstore.yes.my/ywos/signup" target="_blank" rel="noopener"><b>立即获取</b></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="d-block text-white">
        <div class="acd-pd acd-pd-mobile pb-5" id="table-list">
            <div class="container">
                <div class="main-ttl text-center mb-5">选择您的<span class="yes-font">YES</span>后付配套国庆RM 1 套组（<span class="yes-font">YES</span> Postpaid Merdeka Bundle RM1）</div>
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <img class="d-block d-lg-none" src="/wp-content/themes/yes.my/images/merdeka-63/microsite/table-cn-mobile.png" width="100%" />
                        <img class="d-none d-lg-block" src="/wp-content/themes/yes.my/images/merdeka-63/microsite/table-cn.png" width="100%" />
                    </div>
                </div>
            </div>
        </div>

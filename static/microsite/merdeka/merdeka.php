...
<div class="layer-bgContent">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-7 col-lg-8 text-center">
                        <img class="d-block d-lg-none" src="/wp-content/themes/yes.my/images/merdeka-63/microsite/headline-en-mobile.png" width="100%" />
                        <img class="d-none d-lg-block" src="/wp-content/themes/yes.my/images/merdeka-63/microsite/headline-en.png" width="100%" />
                        <div class="layer-pink">
                            <ul>
                                <li>Lowest Deposit</li>
                                <li>Most Data</li>
                                <li>Cheapest Plan</li>
                            </ul>
                        </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-5 text-center">
                        <div class="cp-02 d-lg-none mb-5">GET A <b>SAMSUNG GALAXY A02</b> FOR ONLY <span class="tag-bgWhite">RM1</span></div>
                        <img class="img-phone2" src="/wp-content/themes/yes.my/images/merdeka-63/microsite/handphone.png" width="100%" />
                    </div>
                    <div class="col-lg-7">
                        <div class="cp-02 d-none d-lg-block">GET A <b>SAMSUNG GALAXY A02</b> FOR ONLY <span class="tag-bgWhite">RM1</span></div>
                        <div class="row">
                            <div class="col-lg-7">
                                <div class="ico-ar mb-4">
                                    <div class="row justify-content-center">
                                        <div class="col-lg col-4 mt-3">
                                            ...
                                            <div class="tag xs mt-2">Smartphone <br />Only RM1</div>
                                        </div>
                                        <div class="col-lg col-4 mt-3">
                                            <img alt="" src="/wp-content/themes/yes.my/images/prihatin/phase-2/icon-free-data-100gb.png" width="100%">
                                            <div class="tag xs mt-2">100GB Data + <br />Unlimited Data</div>
                                        </div>
                                        <div class="col-lg col-4 mt-3">
                        ...
                        <div class="cp-03 mb-4 pt-3">With the <span class="yes-font">YES</span> POSTPAID MERDEKA BUNDLE RM1, you get to enjoy a new smartphone device at only RM1 delivered free of charge direct to your home plus up to 100GB data monthly for 12 months.</div>
                        <div class="text-center-mobile">
                            <a class="btn-01 tuntut" href="https://appstore.yes.my/ywos/signup" target="_blank" rel="noopener"><b>GET IT NOW</b></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="d-block text-white">
        <div class="acd-pd acd-pd-mobile pb-5" id="table-list">
            <div class="container">
                <div class="main-ttl text-center mb-5">Pick your <span class="yes-font">yes</span> Postpaid Merdeka Bundle RM1</div>
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <img class="d-block d-lg-none" src="/wp-content/themes/yes.my/images/merdeka-63/microsite/table-en-mobile.png" width="100%" />
                        <img class="d-none d-lg-block" src="/wp-content/themes/yes.my/images/merdeka-63/microsite/table-en.png" width="100%" />
                    </div>
                </div>
            </div>
        </div>

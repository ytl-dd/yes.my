...
<style type="text/css">
    ...
    .layer-floatEarn { background: url('/wp-content/themes/yes.my/images/pakej-keluarga-malaysia/bg-earn.png') no-repeat; background-size: contain; font-size: 20px; line-height: 25px; height: 180px; padding: 25px 15px; text-align: center; width: 180px; position: absolute; right: -100px; top: -150px; }
    ...
    @media (max-width: 769px) {
        ...
        .layer-contentBoxes .layer-contentBox { display: block; border-right: 0; border-bottom: 1px solid #FFF; font-size: 22px; line-height: 24px; }
        .layer-contentBox:first-of-type, .layer-contentBox.bg-white { border-radius: 10px 10px 0 0; border: 0; display: inline-block; }
...
<div class="layer-bgContent">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-10 offset-lg-1">
                        <div class="cp-03 text-white mb-5 text-center">Choose <span class="yes-font">yes</span> plans for quality online experience at the best price. With Pakej Peranti and Pakej Remaja, you get higher data, better connectivity and faster speeds.</div>
                    </div>
                </div>
                <div class="btn-ar mx-auto">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <a href="#postpaid" class="btn-01 pink btn-scroll-down"><b>POSTPAID</b></a>
                        </div>
                        <div class="col-lg-4 mt-lg-0 mt-3">
                            <a href="#prepaid" class="btn-01 btn-scroll-down"><b>PREPAID</b></a>
                        </div>
                        <div class="col-lg-2"></div>
                    </div>
                </div>
    ...
    <section class="d-block text-white" id="postpaid">
        <div class="acd-pd acd-pd-mobile">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 text-center"><img src="/wp-content/themes/yes.my/images/pakej-keluarga-malaysia/heading-postpaid.png" alt="Postpaid" title="Postpaid" class="img-fluid img-heading mb-5" /></div>
                </div>
                <div class="row">
                    <div class="col-12">
    ...
    <section class="d-block text-white" id="prepaid">
        <div class="acd-pd acd-pd-mobile">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 text-center"><img src="/wp-content/themes/yes.my/images/pakej-keluarga-malaysia/heading-prepaid.png" alt="Prepaid" title="Prepaid" class="img-fluid img-heading mb-5" /></div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="cp-01 mb-4"><b><span class="mr-lg-2">• Best value for data</span> • No activation fee</b></div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="layer-contentBoxes bg-blue">
                            ...
                            <div class="layer-contentBox">
                                <span class="tag-bgWhite tag-mb">90 days</span>
                                <b class="b-margin">Validity</b>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="d-none d-lg-block"><img src="/wp-content/themes/yes.my/images/pakej-keluarga-malaysia/heading-pick.png" alt="Pick your YES Pakej Keluarga Malaysia" title="Pick your YES Pakej Keluarga Malaysia" class="img-headingPick" /></div>
                        <div class="d-block d-lg-none"><img src="/wp-content/themes/yes.my/images/pakej-keluarga-malaysia/heading-pick-mobile.png" alt="Pick your YES Pakej Keluarga Malaysia" title="Pick your YES Pakej Keluarga Malaysia" class="img-headingPick" /></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 col-margin">
                        <img src="/wp-content/themes/yes.my/images/pakej-keluarga-malaysia/table-postpaid.png" alt="Pakej Peranti Keluarga Malaysia" title="Pakej Peranti Keluarga Malaysia" class="img-fluid mb-5" />
                        <div class="row">
                            <div class="col-lg-8 offset-lg-2">
                                <a href="https://appstore.yes.my/ywos/signup" class="btn-01 pink" target="_blank"><b>Buy now</b></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <img src="/wp-content/themes/yes.my/images/pakej-keluarga-malaysia/table-prepaid.png" alt="Pakej Remaja Keluarga Malaysia" title="Pakej Remaja Keluarga Malaysia" class="img-fluid mb-5" />
                        <div class="row">
                            <div class="col-lg-8 offset-lg-2">
                                <a href="https://appstore.yes.my/ywos/signup" class="btn-01 pink" target="_blank"><b>Buy now</b></a>
                            </div>

...
<style type="text/css">
    ...
    @media (max-width: 769px) {
        ...
        .layer-floatEarn { font-size: 14px; line-height: 15px; height: 120px; padding: 24px 18px; width: 120px; right: -15px; top: 10px; }
    ...
    <section class="d-block text-white" id="postpaid">
        <div class="acd-pd acd-pd-mobile">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="cp-01 mb-4"><b><span class="mr-lg-2">• 超值上网数据</span> • 无需启用费</b></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="layer-contentBoxes">
                            ...
                            <div class="layer-contentBox">
                                ...
                                <span class="tag-bgWhite tag-mt">只需RM1</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="cp-03">
                            签购 <span class="yes-font">yes</span> 设备配套就能以区区RM1拥有一台 Samsung Galaxy A02！更佳的是，只需每月 RM49，您就能获取100GB数据容量，绝对物超所值！更多的数据配额、更佳的通讯连接及更快速的网速，让您尽享最佳的上网体验。<br /><br />
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="layer-contentBoxes bg-blue">
                            ...
                            <div class="layer-contentBox bg-white"><img src="/wp-content/themes/yes.my/images/pakej-keluarga-malaysia/icon-pakej-remaja-ch.png" alt="Pakej Remaja Keluarga Malaysia" title="Pakej Remaja Keluarga Malaysia" class="img-fluid" /></div>
                            <div class="layer-contentBox">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <div class="d-block d-lg-none"><img src="/wp-content/themes/yes.my/images/pakej-keluarga-malaysia/heading-pick-mobile-ch.png" alt="Pick your YES Pakej Keluarga Malaysia" title="Pick your YES Pakej Keluarga Malaysia" class="img-headingPick" /></div>
                    </div>
                </div>
                <div class="row">

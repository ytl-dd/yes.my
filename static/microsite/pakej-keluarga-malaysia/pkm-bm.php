...
<style type="text/css">
    ...
    @media (max-width: 769px) {
        ...
        .layer-floatEarn { font-size: 10px; line-height: 12px; height: 120px; padding: 28px 15px; width: 120px; right: -15px; top: 10px; }
    ...
    <section class="d-block text-white" id="postpaid">
        <div class="acd-pd acd-pd-mobile">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="cp-01 mb-4"><b><span class="mr-lg-2">• Tawaran hebat untuk data anda</span> • Tiada yuran pengaktifan</b></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="layer-contentBoxes">
                            ...
                            <div class="layer-contentBox">
                                ...
                                <span class="tag-bgWhite tag-mt">Hanya RM1</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="cp-03">
                            Langgan Pakej Peranti <span class="yes-font">yes</span> dan miliki Samsung Galaxy A02 pada hanya RM1! Dengan 100GB data untuk hanya RM49 setiap bulan, pasti memberikan pengalaman internet yang menakjubkan. <br /><br />
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="layer-contentBoxes bg-blue">
                            ...
                            <div class="layer-contentBox bg-white"><img src="/wp-content/themes/yes.my/images/pakej-keluarga-malaysia/icon-pakej-remaja-bm.png" alt="Pakej Remaja Keluarga Malaysia" title="Pakej Remaja Keluarga Malaysia" class="img-fluid" /></div>
                            <div class="layer-contentBox">

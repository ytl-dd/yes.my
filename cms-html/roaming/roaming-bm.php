        ...
        <div class="container">
            <div class="row">
                <div class="col" style="max-width:700px;">
                    <p class="shoutout lg" style="line-height:1.3;">Melancong?<br />
                        Rasakan kedekatan dengan rumah bersama <b>YesRoam.</b></p>

                    <p class="shoutout-note"><b>Berjuang secara bebas di mana saja dengan Rakan Kongsi Pengendali
                            kami.</b></p>
                    &nbsp;
                    ...
                    <div class="row">
                        <div class="col-12 col-md-8">
                            <div class="form-group">
                                <div class="dropdown"><button class="btn dropdown-toggle" data-toggle="dropdown"
                                        type="button">Cuba “Australia“</button>
                        ...
                        <div class="col-12 col-md-4"><button class="btn btn-primary" data-button="openRoaming"
                                type="button">Semak Kadar Roaming</button></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 center-text" style="font-size:12px;">&nbsp;
                        ...
                        <br />
                        <a href="/ms/faq/roaming"><b><u class="accent">Got questions? Click here for FAQ.</u></b></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col">&nbsp;
                        ...
                        <div class="row">
                            <div class="col-12 center-text" style="font-size:12px;">&nbsp;
                                ...
                                <br />
                                <a href="/ms/faq/roaming"><b><u class="accent">Have problems connecting? Click
                                            here.</u></b></a><br />
                                <br />
                                <br />
...
<section class="dblock flexbox">
    <div class="fullscreen centerize">
        <div class="container">
            <div class="row">
                <div class="col">
                    <p class="shoutout lg brand center-text" style="max-width:1000px;margin:0 auto;"><b>RM38/hari</b>,
                        sehingga&nbsp;<b>500MB</b> di&nbsp;<b>24 negara ini</b>.</p>
                    &nbsp;
...
<section class="dblock flexbox light" id="searchIdd"
    style="background-image:url('/wp-content/themes/yes.my/images/yes2018/Group 2710.jpg');">
    <div class="fullscreen centerize">
        <div class="container">
            <div class="row">
                <div class="col" style="max-width:887px;">
                    <p class="shoutout lg" style="line-height:1.3;">Dari Malaysia ke mana-mana di dunia<b>.</b></p>
                    &nbsp;
                    ...
                    <div class="row">
                        <div class="col-12 col-md-8">
                            <div class="form-group">
                                <div class="dropdown"><button class="btn dropdown-toggle" data-toggle="dropdown"
                                        type="button">Cuba “Cambodia”</button>
                        ...
                        <div class="col-12 col-md-4"><button class="btn btn-primary" data-button="openIdd"
                                type="button">Semak kadar IDD</button></div>
                    </div>
                </div>
            </div>
        </div>

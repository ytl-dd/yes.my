...
<section class="position-relative d-flex align-items-start">
    <img alt="" class="img-fluid d-view" data-entity-type="" data-entity-uuid=""
        src="/wp-content/themes/yes.my/images/kasiupb40/kasihup_pre_EN_01.jpg" />
    <img alt="" class="img-fluid m-view" data-entity-type="" data-entity-uuid=""
        src="/wp-content/themes/yes.my/images/kasiupb40/kasihup_pre_Mobile_EN_01.jpg" />
    <!--  -->
    <div class="position-absolute d-flex align-items-center justify-content-center w-100 bnrtext">
        <div class="d-flex align-items-center justify-content-center w-100 text-white text-center font_normal">
            <a class="btnborder d-flex btnborder bg-pink text-white button_bnr Vagbold"
                href="https://appstore.yes.my/ywos/signup" target="_blank">GET IT NOW</a>
        </div>
    </div>
    <!--  -->
</section>
...
<section class="position-relative d-flex align-items-start">
    <img alt="" class="img-fluid d-view" data-entity-type="" data-entity-uuid=""
        src="/wp-content/themes/yes.my/images/kasiupb40/kasihup_pre_EN_02.jpg" />
    <img alt="" class="img-fluid m-view" data-entity-type="" data-entity-uuid=""
        src="/wp-content/themes/yes.my/images/kasiupb40/kasihup_pre_Mobile_EN_02.png" />
    <!--  -->
        ...
        <div class="d-flex align-items-center justify-content-center w-100 text-white text-center font_normal">
            <div class="d-flex flex-column">
                <p class="m-text m-0 text-white">
                    Enjoy 4G data up to <b>40GB for free!</b>
                </p>

                <p class="m-text m-0 text-white">
                    Exclusive for <b>all B40s</b><br class="m-view" />
                    only with <b>yes.</b>
                </p>
            </div>
        </div>
...
<section class="position-relative d-flex align-items-start">
    <img alt="" class="img-fluid d-view" data-entity-type="" data-entity-uuid=""
        src="/wp-content/themes/yes.my/images/kasiupb40/40-GBfor-B40-Landing-Page-EN.jpeg" />
    <img alt="" class="img-fluid m-view" data-entity-type="" data-entity-uuid=""
        src="/wp-content/themes/yes.my/images/kasiupb40/40-GBfor-B40-Landing-Page-Mobile-EN-1.png" />
    <!--  -->
    <div class="position-absolute d-flex align-items-center justify-content-center w-100 bnrtext3">
        <div class="d-flex align-items-center justify-content-center w-100 text-white text-center font_normal">
            <div class="d-flex flex-column align-items-start">
                <p class="m-0 m-text text-white">
                    Get your <b>free</b> SIM sent straight to you!
                </p>
        ...
        <div class="flex-column termsncond m-view">
            <a class="m-0 vlight" href="https://www.yes.my/tnc/ongoing-campaigns-tnc" target="_blank">*Terms and
                conditions apply</a>
        </div>
    </div>
...
<section class="position-relative d-flex align-items-start">
    <img alt="" class="img-fluid d-view" data-entity-type="" data-entity-uuid=""
        src="/wp-content/themes/yes.my/images/kasiupb40/kasihup_pre_EN_05.jpg" />
    <img alt="" class="img-fluid m-view" data-entity-type="" data-entity-uuid=""
        src="/wp-content/themes/yes.my/images/kasiupb40/kasihup_pre_Mobile_EN_05.png" />
    <!--  -->
    <div class="position-absolute d-flex align-items-center justify-content-center w-100 bnrtext4">
        <div
            ...
            <h2>
                Want to know if<br class="m-view" />
                you’re eligible?<br class="m-view" />
                Check now!
            </h2>
            <a class="btnborder d-flex btnborder bg-pink text-white button_bnr Vagbold button_bnr_footer"
                href="https://bpr.hasil.gov.my/LogMasuk.aspx" target="_blank">CHECK ELIGIBILITY</a>
        </div>
    </div>
    <!--  -->
</section>
